...
data class RecipeSearch(
    ...
    @SerialName("recipe_ingredients") val recipeIngredientsSearch: RecipeIngredientsSearch?,
    @SerialName("recipe_name") val recipeName: String? = null,
    @SerialName("recipe_nutrition") val recipeNutritionSearch: RecipeNutritionSearch?,
    @SerialName("recipe_types") val recipeTypesSearch: RecipeTypesSearch?
)